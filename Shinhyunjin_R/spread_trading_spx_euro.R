...
getSymbols('^GSPC', start="2014-01-01")
getSymbols('^STOXX50E', start="2014-01-01")
...
# specific period #
par(mar=c(5,4,4,5))
plot(tail(df$GHratio, 252), type = "l", main = "spx - euro50 Ratio", ylim = c(400, 650))
...
plot(data_is$spread, main = "euro50 vs spx (IS)",
     cex.main = 0.8, cex.lab = 0.8, cex.axis = 0.8)
...
range_os <- paste(start_date_os, "::", end_date_os, sep ="")
...
sharpe_ratio(equity_curve_returns[!invalid_values], 0.015)
