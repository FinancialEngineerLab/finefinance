...
getSymbols("001450.KS", src = "yahoo")
stock <- `001450.KS`[,'001450.KS.Close']
...
data_coef <- read.zoo("c:/users/shinhyunjin/dropbox/data/Hull and White/dataset3.csv",index.column =1,
                      sep = ",", header = TRUE)
