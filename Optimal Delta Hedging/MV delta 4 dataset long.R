...
getSymbols("036570.KS", src = "yahoo")
stock <- `036570.KS`[,'036570.KS.Close']
...
data_coef <- read.zoo("c:/users/shinhyunjin/dropbox/data/Hull and White/dataset4long.csv",index.column =1,
                      sep = ",", header = TRUE)
