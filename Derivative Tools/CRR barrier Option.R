...
BSBarrier <- BarrierOption("downout","call" ,100,100,0,0.1, 0.2, 0.3, barrier = 95)$value
BSBarrier
...
#result<-getBinomTree.ko(100,100,0.3,0.2,0.1,0,n,isPut = F,95)$P[1]
#result 

result1 <- getBinomTree.ko(100,100,0.3,0.2,0.1,0,50, isPut = F, H=95)$P[1]
result1

for (i in n){
  result[i-49] <- getBinomTree.ko(100,100,0.3,0.2,0.1,0,i,isPut = F,H=95)$P[1]
}
